...
export function AssignmentsPage() {
  ...
  return (
    <section className="page-section" id="assignments">
      <div className="section-heading">
        <div>
          <h2>Assignments</h2>
          <p>Assign approved screens or screen groups to programs.</p>
        </div>
              ...
              return (
                <article className="assignment-card" key={assignment.id}>
                  <div className="assignment-card-summary">
                    ...
                    <small>Updated {formatDateTime(assignment.updatedAt)}</small>
                  </div>
                  <div className="assignment-form-grid">
                    <label>
                      Target type
