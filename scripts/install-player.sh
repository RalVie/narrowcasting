...
RUNTIME_WATCHDOG_ENABLED=1
RUNTIME_WATCHDOG_INTERVAL_MS=30000
RUNTIME_WATCHDOG_PLAYER_URL=http://localhost:4174/player
RUNTIME_WATCHDOG_STATUS_PATH=../player/public/data/runtime-watchdog-status.json
RUNTIME_WATCHDOG_MAX_CHROMIUM_RESTARTS=3
RUNTIME_WATCHDOG_WINDOW_MS=300000
RUNTIME_WATCHDOG_ALLOW_REBOOT=0"
}
